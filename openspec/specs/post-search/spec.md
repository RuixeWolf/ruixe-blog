# Post Search Specification

## Purpose

定义 Ruixe Blog 的客户端文章搜索能力，包括服务端搜索索引构建（Fuse.js）、全局键盘快捷键与 Header 按钮触发、客户端模糊搜索、locale 范围限定、搜索弹窗 UI（HeroUI Modal）、结果展示与键盘导航、跳转，以及搜索功能 i18n。
